...
# Yangilangan: 2026-05-19 (T-438..T-466 qo'shildi — Landing page tasklar to'liq)
...
- **Sub-tasklar:** T-438..T-466 (quyida batafsil)
...
# ══════════════════════════════════════════════════════════════
# LANDING PAGE — BARCHA TASKLAR (T-438..T-466)
# Master task: T-427 | Plan: docs/LANDING_PAGE_PLAN.md
# Ziyoda (kod), Hobbit (kontent), Ibrat (deploy/agents), Bekzod (QA)
# ══════════════════════════════════════════════════════════════
...
## T-458 | P1 | [LANDING] | Video skriptlar — 8 ta video darslik matni

- **Sana:** 2026-05-19
- **Mas'ul:** Hobbit (matn) + Bekzod (tekshiruv)
- **Fayl:** `docs/content/video-scripts/`
- **Matn manba:** `docs/LANDING_PAGE_PLAN.md` → ЧАСТЬ 3
- **Vazifa:**
  - 8 ta video skript yozish (timestamp formatda):
    1. "RAOS ga xush kelibsiz — 2 daqiqada boshlang" (3 min)
    2. "Tovar qo'shish — 3 xil usul" (5 min)
    3. "Savdo qilish — qadamba-qadam" (4 min)
    4. "Hisobotlar — pulni nazorat qiling" (3 min)
    5. "Xodimlarni boshqarish" (3 min)
    6. "Inventar boshqaruvi" (4 min)
    7. "Ko'p filial boshqaruvi" (4 min)
    8. "Soliq cheki va OFD sozlash" (3 min)
  - Har skript: [0:00-0:30] formatda, oddiy til, texnik so'zlarsiz
  - O'zbek tilida (keyin RU tarjima)
- **Kutilgan:** 8 ta tayyor skript — yozishga tayyor
- **Muddat:** 3 kun
- **Nima uchun Landing:** /tutorials sahifasi kontentsiz bo'sh qoladi. Video — konversiyani 80% oshiradi (mijoz ko'radi → ishonadi → ro'yxatdan o'tadi)

---

## T-459 | P2 | [LANDING] | Video prodakshn — yozish, montaj, YouTube yuklash

- **Sana:** 2026-05-19
- **Mas'ul:** Jamoa (voiceover) + Bekzod (montaj/YouTube)
- **Vazifa:**
  - OBS Studio / Loom da screen recording (RAOS demo muhitda)
  - Voiceover: O'zbek tilida, sekin va aniq
  - Montaj: kesish, subtitle (UZ + RU), intro/outro, fon musiqa
  - YouTube kanal: RAOS — kanalga yuklash
  - Thumbnail: Canva da shablon (har video uchun)
  - Landing /tutorials sahifasiga YouTube embed qo'shish
- **Bog'liq:** T-458 (skriptlar tayyor bo'lishi kerak), T-460 (YouTube kanal)
- **Kutilgan:** 8 ta professional video YouTube da
- **Muddat:** 1 hafta (skriptlardan keyin)
- **Nima uchun Landing:** "Video darsliklar" section landing da bor (T-452). Videosiz — bo'sh placeholder qoladi. Raqiblarning hech birida video tutorial yo'q — bu RAOS USP.

---

## T-460 | P1 | [LANDING] | YouTube kanal + Instagram @raos.uz ochish

- **Sana:** 2026-05-19
- **Mas'ul:** Bekzod (akkauntlar) + Hobbit (kontent reja)
- **Vazifa:**
  - YouTube kanal ochish: "RAOS — Kassa tizimi"
    - Logo, banner, about text (UZ + RU)
    - Playlist: "Boshlash", "Boshqaruv"
  - Instagram @raos.uz ochish:
    - Bio: "Do'konlar uchun eng oson kassa tizimi"
    - 9 ta boshlang'ich post (grid design — Canva)
    - Link in bio → raos.uz
  - Telegram @raos_support kanal tekshirish
- **Kutilgan:** 3 ta ijtimoiy tarmoq tayyor, landing footer da link ishlaydi
- **Muddat:** 1 kun
- **Nima uchun Landing:** Footer da Telegram, Instagram, YouTube linklari bor (T-448). Link bosilsa — bo'sh sahifa ochilmasligi kerak.

---

## T-461 | P1 | [LANDING] | Domain raos.uz sotib olish + DNS sozlash

- **Sana:** 2026-05-19
- **Mas'ul:** AbdulazizYormatov (CEO qaror) + Ibrat (DNS)
- **Vazifa:**
  - raos.uz domenini sotib olish (~$15/yil — webhost.uz yoki ahost.uz)
  - DNS: A record → deploy hostiga yo'naltirish
  - SSL sertifikat (avtomatik — Vercel/Railway)
  - Email: hello@raos.uz (optsional — Yandex 360 / Google Workspace)
- **Kutilgan:** raos.uz ochilganda landing ko'rinadi
- **Muddat:** 1 kun (sotib olish) + 24 soat (DNS propagatsiya)
- **Nima uchun Landing:** Landing page hech kimga foyda bermaydi agar URL yo'q bo'lsa. "raos.uz" — barcha CTA, QR kod, vizitka, reklamada ishlatiladi.

---

## T-462 | P1 | [LANDING] | Deploy — Vercel yoki Railway ga landing chiqarish

- **Sana:** 2026-05-19
- **Mas'ul:** Ibrat
- **Fayl:** `apps/landing/` deploy config
- **Vazifa:**
  - Variant A: Vercel (bepul hobby plan — landing uchun yetarli)
    - `vercel.json` config, build command: `pnpm --filter landing build`
    - Custom domain: raos.uz → Vercel
  - Variant B: Railway (allaqachon ishlatilmoqda)
    - Dockerfile yoki Nixpacks
    - Custom domain ulash
  - CI/CD: main ga push → avtomatik deploy
  - Analytics: Vercel Analytics yoki Google Analytics 4
  - Monitoring: uptime check (UptimeRobot — bepul)
- **Bog'liq:** T-461 (domain tayyor bo'lishi kerak)
- **Kutilgan:** raos.uz live, avtomatik deploy ishlaydi
- **Muddat:** 0.5 kun
- **Nima uchun Landing:** Eng zo'r landing page localhost:3002 da tursa — hech kim ko'rmaydi. Deploy = mijozlar ko'radi.

---

## T-463 | P2 | [LANDING] | Claude agents yaratish — landing-builder, video-script-writer, content-writer

- **Sana:** 2026-05-19
- **Mas'ul:** Ibrat
- **Fayl:** `.claude/agents/`
- **Vazifa:**
  - `landing-builder.md` — Landing komponentlar yaratish/o'zgartirish agenti
    - Zona: apps/landing/ FAQAT
    - Tailwind 4 + Next.js 15 App Router qoidalari
    - SEO, responsive, accessibility avtomatik
  - `video-script-writer.md` — Video skript yozish/tahrirlash agenti
    - Zona: docs/content/video-scripts/
    - O'zbek tili, timestamp format, oddiy til
  - `content-writer.md` — Marketing kontent agenti
    - Zona: apps/landing/src/lib/, docs/content/
    - 3 tilda (UZ/RU/EN), oddiy til, raqobat fakt
- **Matn manba:** `docs/LANDING_PAGE_PLAN.md` → ЧАСТЬ 4.1
- **Kutilgan:** Ziyoda va Hobbit agentlar yordamida tezroq ishlaydi
- **Muddat:** 0.5 kun
- **Nima uchun Landing:** Agentlar = Ziyoda va Hobbit uchun Claude yordamchi. Har safar qoidalarni qo'lda yozish o'rniga, agent avtomatik biladi nima qilish kerak.

---

## T-464 | P2 | [LANDING] | Claude skills yaratish — /landing, /video-tutorial
...
- **Vazifa:**
  - `/landing` skill:
    - `/landing add-section [name]` — yangi section qo'shish
    - `/landing update-pricing` — narxlarni yangilash
    - `/landing add-language [code]` — yangi til qo'shish
  - `/video-tutorial` skill:
    - `/video-tutorial new "[title]"` — yangi skript yaratish
    - `/video-tutorial translate [num] [lang]` — tarjima
    - `/video-tutorial list` — barcha skriptlar ro'yxati
- **Matn manba:** `docs/LANDING_PAGE_PLAN.md` → ЧАСТЬ 4.2
- **Kutilgan:** Tez buyruqlar bilan landing/video boshqarish
- **Muddat:** 0.5 kun
- **Nima uchun Landing:** Skill = tezkor buyruq. `/landing update-pricing` 1 so'z bilan narx o'zgartiradi — 10 fayl qidirib o'tirish o'rniga.

---

## T-465 | P2 | [LANDING] | Skrinshot va mockup tayyorlash — Hero + Features uchun

- **Sana:** 2026-05-19
- **Mas'ul:** Ibrat (skrinshot) + Ziyoda (joylashtirish)
- **Vazifa:**
  - POS interfeys skrinshoti (planshet mockup da)
  - Owner mobile app skrinshoti (telefon mockup da)
  - Dashboard skrinshoti (Admin panel)
  - Mockup frame: mockuphone.com yoki Figma
  - Optimize: WebP format, next/image bilan
  - Hero section va Features section ga joylashtirish
- **Kutilgan:** Professional ko'rinish — real mahsulot skrinshoti
- **Muddat:** 1 kun
- **Nima uchun Landing:** Hero section rasm o'rniga placeholder tursa — "startup emas, maktab loyihasi" taassurot qoldiradi. Real skrinshot = ishonch.

---

## T-466 | P1 | [LANDING] | Kontent tekshiruv — UZ/RU matnlar Bekzod tasdiqlashi

- **Sana:** 2026-05-19
- **Mas'ul:** Bekzod (QA) + Hobbit (tuzatish)
- **Vazifa:**
  - Barcha UZ matnlarni o'qib tekshirish (grammatika, mantiq, uslub)
  - RU tarjimani tekshirish (tabiiy bo'lishi)
  - Raqamlar to'g'riligini tasdiqlash (narxlar, foizlar, muddat)
  - Raqiblar haqidagi faktlar tekshiruvi (BILLZ narxi, YesPOS narxi)
  - Noto'g'ri/noaniq joylarni belgilash → Hobbit tuzatadi
- **Kutilgan:** 100% to'g'ri matn, noto'g'ri ma'lumot yo'q
- **Muddat:** 1 kun (UZ) + 1 kun (RU)
- **Nima uchun Landing:** Bitta noto'g'ri narx yoki grammatik xato = ishonch yo'qoladi. B2B saytda professional matn = professional kompaniya.
