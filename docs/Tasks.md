...
## T-242 | P2 | [FRONTEND] | Dashboard — KPI kartalar va empty state

- **Sana:** 2026-03-18
- **Mas'ul:** AbdulazizYormatov
- **Fayl:** `apps/web/src/app/(admin)/dashboard/page.tsx`
- **Muammo (vizual):**
  - Backend offline bo'lganda "Xato" xabari chiqadi — yomon UX
  - KPI kartalar mavjud emas yoki noto'g'ri joylashgan
  - Empty state dizayni yo'q
- **Kutilgan:**
  - Backend offline → skeleton loader → "Ma'lumot topilmadi" (icon + matn)
  - KPI kartalar: Bugungi tushum, Foyda, Buyurtmalar soni, Aktiv smena
  - Trend arrows: +5% ↑ (yashil), -3% ↓ (qizil)
