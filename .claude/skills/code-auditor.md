...
argument-hint: path to audit (default: current directory), or focus area (security/performance/testing/architecture)
---
...
If a path is provided, focus audit on that directory. If a focus area is provided (security/performance/testing/architecture), prioritize that dimension.
...
- **Agent (Explore)**: Thorough codebase exploration
