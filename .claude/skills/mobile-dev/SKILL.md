---
name: mobile-dev
description: React Native development guide — components, navigation, styling, performance, build. Use when working on apps/mobile/.
...
Source: ClawHub @ivangdavila/react-native (MIT-0)
...
- Native crashes don't show in JS debugger — check Android Studio Logcat
...
## Platform Differences (Android focus)

- Android needs explicit `overflow: 'hidden'` for border radius clipping
