...
const DEFAULT_SEVERITY_CONFIG = { bg: Colors.infoLight, text: Colors.info, iconColor: Colors.info, icon: 'information-circle' as const };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.list}>
        {data.map((item) => {
          const cfg = SEVERITY_CONFIG[item.severity] ?? DEFAULT_SEVERITY_CONFIG;
          return (
