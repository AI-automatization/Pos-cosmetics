...
async function bootstrap() {
  ...
  const corsOriginRaw = config.get<string>(
    'CORS_ORIGIN',
    'http://localhost:3001,http://localhost:3000,http://localhost:3003,http://localhost:3004,https://web-production-5b0b7.up.railway.app,https://super-admin-production-a0db.up.railway.app,https://raos.uz,https://www.raos.uz',
  );
